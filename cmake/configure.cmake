...
endmacro() 
list(APPEND CMAKE_REQUIRED_INCLUDES ${CMAKE_SOURCE_DIR}/src/headers ${CMAKE_SOURCE_DIR}/src/headers/spatlite ${CMAKE_CURRENT_BINARY_DIR})
...
file(READ ${CMAKE_CURRENT_SOURCE_DIR}/config.h.in _tmp_text)
...
file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/config.h.in ${_tmp_text})
if(MSVC)
  configure_file(${CMAKE_CURRENT_BINARY_DIR}/config.h.in ${CMAKE_CURRENT_BINARY_DIR}/config-msvc.h)
else()
